...
Analyzed 42 topics
Total unique terms: 936
Total term occurrences: 6993

Uniqueness Multipliers:
- < 10% of topics: 2.0x (highly unique, topic-specific)
- 10-25% of topics: 1.5x (moderately unique)
- ≥ 25% of topics: 1.0x (common across corpus)

| Term | Type | Total Count | Document Count | Topics | Weighted Entropy | Uniqueness Mult | Final Score |
|------|------|-------------|----------------|--------|------------------|-----------------|-------------|
| file-based apps | compound | 14 | 1 | file-based-apps | 5.817 | 2.0x | 11.633 |
| object initialization | compound | 10 | 1 | object-initialization | 5.757 | 2.0x | 11.513 |
| anonymous types | compound | 8 | 1 | object-initialization | 5.727 | 2.0x | 11.453 |
| async operations | compound | 8 | 1 | async-await | 5.727 | 2.0x | 11.453 |
| collection properties | compound | 8 | 1 | object-initialization | 5.727 | 2.0x | 11.453 |
| extension members | compound | 8 | 1 | type-extensions | 5.727 | 2.0x | 11.453 |
| inline array | compound | 8 | 1 | inline-arrays | 5.727 | 2.0x | 11.453 |
| pattern matching | compound | 8 | 1 | span-based-string-processing | 5.727 | 2.0x | 11.453 |
| async linq | compound | 7 | 1 | system-collections-generic-iasyncenumerable | 5.712 | 2.0x | 11.423 |
| framework-dependent | compound | 7 | 1 | publishing-and-deployment | 5.712 | 2.0x | 11.423 |
| stack allocation | compound | 7 | 1 | collections-performance | 5.712 | 2.0x | 11.423 |
| array interface devirtualization | compound | 6 | 1 | collections-performance | 5.697 | 2.0x | 11.393 |
| collection initialization | compound | 6 | 1 | collection-initialization | 5.697 | 2.0x | 11.393 |
| file-based-programs | compound | 6 | 1 | file-based-apps | 5.697 | 2.0x | 11.393 |
| file-level | compound | 6 | 1 | file-based-apps | 5.697 | 2.0x | 11.393 |
| init properties | compound | 6 | 1 | object-initialization | 5.697 | 2.0x | 11.393 |
| json documents | compound | 6 | 1 | system-text-json-nodes | 5.697 | 2.0x | 11.393 |
| system.text.json.nodes | compound | 6 | 1 | system-text-json-nodes | 5.697 | 2.0x | 11.393 |
| expression lambdas | compound | 5 | 1 | lambda-expressions | 5.682 | 2.0x | 11.363 |
| extension methods | compound | 5 | 1 | type-extensions | 5.682 | 2.0x | 11.363 |
| microsoft.extensions.ai | compound | 5 | 1 | microsoft-extensions-ai | 5.682 | 2.0x | 11.363 |
| microsoft.extensions.ai.evaluation | compound | 5 | 1 | microsoft-extensions-ai-evaluation | 5.682 | 2.0x | 11.363 |
| middleware composition | compound | 5 | 1 | microsoft-extensions-ai | 5.682 | 2.0x | 11.363 |
| open-source | compound | 5 | 1 | dotnet | 5.682 | 2.0x | 11.363 |
| partial classes | compound | 5 | 1 | partial-classes | 5.682 | 2.0x | 11.363 |
| required members | compound | 5 | 1 | object-initialization | 5.682 | 2.0x | 11.363 |
| small arrays | compound | 5 | 1 | collections-performance | 5.682 | 2.0x | 11.363 |
| string normalization | compound | 5 | 1 | span-based-string-processing | 5.682 | 2.0x | 11.363 |
| system.text.json.jsondocument | compound | 5 | 1 | system-text-json-jsondocument | 5.682 | 2.0x | 11.363 |
| system.text.json.jsonserializer | compound | 5 | 1 | system-text-json-jsonserializer | 5.682 | 2.0x | 11.363 |
...
| development workflow | compound | 3 | 1 | cli | 5.652 | 2.0x | 11.303 |
...
| yield return | compound | 3 | 1 | system-collections-generic-ienumerable | 5.652 | 2.0x | 11.303 |
...
| dependency resolution | compound | 2 | 1 | build-and-compilation | 5.637 | 2.0x | 11.273 |
...
| linq integration | compound | 2 | 1 | system-collections-generic-ienumerable | 5.637 | 2.0x | 11.273 |
...
| project structure | compound | 2 | 1 | file-based-apps | 5.637 | 2.0x | 11.273 |
...
| using assembly trimming | compound | 2 | 1 | assembly-trimming | 5.637 | 2.0x | 11.273 |
...
| pattern-based | compound | 4 | 2 | csharp, string-search-operations | 4.627 | 2.0x | 9.254 |
...
| operations | single | 11 | 1 | async-await | 3.848 | 2.0x | 7.695 |
...
| benefits | single | 6 | 1 | publishing-and-deployment | 3.798 | 2.0x | 7.595 |
...
| extract | single | 5 | 1 | system-text-json-jsondocument | 3.788 | 2.0x | 7.575 |
...
| customization | single | 4 | 1 | system-text-json-jsonserializer | 3.778 | 2.0x | 7.555 |
...
| one | single | 4 | 1 | partial-classes | 3.778 | 2.0x | 7.555 |
...
| asynchronous | single | 3 | 1 | async-await | 3.768 | 2.0x | 7.535 |
...
| creates | single | 3 | 1 | system-collections-generic-ienumerable | 3.768 | 2.0x | 7.535 |
...
| fluent | single | 3 | 1 | type-extensions | 3.768 | 2.0x | 7.535 |
...
| namespaces | single | 3 | 1 | system-text-json-migrate-from-newtonsoft | 3.768 | 2.0x | 7.535 |
...
| replace | single | 3 | 1 | inline-arrays | 3.768 | 2.0x | 7.535 |
...
| telemetry | single | 3 | 1 | microsoft-extensions-ai | 3.768 | 2.0x | 7.535 |
...
| serialization | single | 19 | 2 | system-text-json, system-text-json-jsonserializer | 3.235 | 2.0x | 6.469 |
...
| familiar | single | 8 | 2 | collection-expressions, microsoft-extensions-ai | 3.125 | 2.0x | 6.249 |
...
| comprehensive | single | 6 | 2 | microsoft-extensions-ai-evaluation, microsoft-extensions-http-resilience | 3.105 | 2.0x | 6.209 |
...
| substring | single | 6 | 2 | string-search-operations, system-buffers-searchvalues | 3.105 | 2.0x | 6.209 |
| synchronization | single | 6 | 2 | async-await, system-threading-tasks-task | 3.105 | 2.0x | 6.209 |
| these | single | 6 | 2 | collections-performance, json-validation-security | 3.105 | 2.0x | 6.209 |
| used | single | 6 | 2 | dotnet, system-buffers-searchvalues | 3.105 | 2.0x | 6.209 |
...
| minimal | single | 26 | 3 | publishing-and-deployment, system-text-json, system-text-json-jsondocument | 2.899 | 2.0x | 5.798 |
| keyword | single | 20 | 3 | csharp-14-features, partial-classes, properties-backing-fields | 2.839 | 2.0x | 5.678 |
| while | single | 20 | 3 | csharp, dotnet, file-based-apps | 2.839 | 2.0x | 5.678 |
| compilation | single | 19 | 3 | build-and-compilation, native-aot, publishing-and-deployment | 2.829 | 2.0x | 5.658 |
| enumeration | single | 18 | 3 | collections-performance, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable | 2.819 | 2.0x | 5.638 |
| consider | single | 16 | 3 | system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-threading-tasks-task | 2.799 | 2.0x | 5.598 |
| mutable | single | 16 | 3 | system-text-json, system-text-json-jsondocument, system-text-json-nodes | 2.799 | 2.0x | 5.598 |
| commands | single | 15 | 3 | build-and-compilation, cli, system-commandline | 2.789 | 2.0x | 5.578 |
| http | single | 15 | 3 | json-streaming-io, microsoft-extensions-http-resilience, system-text-json | 2.789 | 2.0x | 5.578 |
| write | single | 15 | 3 | async-await, csharp, system-text-json-utf8jsonwriter | 2.789 | 2.0x | 5.578 |
| each | single | 14 | 3 | system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json | 2.779 | 2.0x | 5.558 |
| enables | single | 14 | 3 | csharp, dotnet, system-text-json | 2.779 | 2.0x | 5.558 |
| full | single | 14 | 3 | file-based-apps, inline-arrays, system-text-json-jsondocument | 2.779 | 2.0x | 5.558 |
| process | single | 14 | 3 | span-based-string-processing, system-text-json-jsondocument, system-text-json-utf8jsonreader | 2.779 | 2.0x | 5.558 |
| web | single | 14 | 3 | csharp, system-text-json, system-text-json-jsonserializer | 2.779 | 2.0x | 5.558 |
| caching | single | 13 | 3 | cli, microsoft-extensions-ai, microsoft-extensions-ai-evaluation | 2.769 | 2.0x | 5.538 |
| primary | single | 13 | 3 | cli, partial-classes, properties-backing-fields | 2.769 | 2.0x | 5.538 |
| standard | single | 13 | 3 | file-based-apps, microsoft-extensions-ai, microsoft-extensions-http-resilience | 2.769 | 2.0x | 5.538 |
| code | single | 12 | 3 | async-await, csharp, dotnet | 2.759 | 2.0x | 5.518 |
| heap | single | 12 | 3 | collections-performance, inline-arrays, span-based-string-processing | 2.759 | 2.0x | 5.518 |
| pipeline | single | 12 | 3 | cli, json-streaming-io, microsoft-extensions-http-resilience | 2.759 | 2.0x | 5.518 |
| searching | single | 12 | 3 | span-based-string-processing, string-search-operations, system-buffers-searchvalues | 2.759 | 2.0x | 5.518 |
| constructor | single | 11 | 3 | object-initialization, properties-backing-fields, system-text-json-jsonserializer | 2.749 | 2.0x | 5.498 |
| different | single | 11 | 3 | partial-classes, system-text-json, system-text-json-migrate-from-newtonsoft | 2.749 | 2.0x | 5.498 |
| many | single | 11 | 3 | csharp, dotnet, span-based-string-processing | 2.749 | 2.0x | 5.498 |
| maximum | single | 11 | 3 | system-text-json, system-text-json-jsonserializer, system-text-json-utf8jsonwriter | 2.749 | 2.0x | 5.498 |
| queries | single | 11 | 3 | async-await, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable | 2.749 | 2.0x | 5.498 |
| changes | single | 10 | 3 | collections-performance, microsoft-extensions-ai, system-text-json | 2.739 | 2.0x | 5.478 |
| character | single | 10 | 3 | span-based-string-processing, string-search-operations, system-buffers-searchvalues | 2.739 | 2.0x | 5.478 |
| ci | single | 10 | 3 | build-and-compilation, cli, microsoft-extensions-ai-evaluation | 2.739 | 2.0x | 5.478 |
| constructors | single | 10 | 3 | object-initialization, partial-classes, properties-backing-fields | 2.739 | 2.0x | 5.478 |
| set | single | 10 | 3 | dotnet, properties-backing-fields, system-buffers-searchvalues | 2.739 | 2.0x | 5.478 |
| structures | single | 10 | 3 | file-based-apps, inline-arrays, system-text-json-nodes | 2.739 | 2.0x | 5.478 |
| existing | single | 9 | 3 | collection-initialization, system-text-json-migrate-from-newtonsoft, type-extensions | 2.729 | 2.0x | 5.458 |
| parallel | single | 9 | 3 | async-await, build-and-compilation, system-threading-tasks-task | 2.729 | 2.0x | 5.458 |
| deserialization | single | 33 | 4 | json-validation-security, system-text-json, system-text-json-jsondocument, system-text-json-jsonserializer | 2.681 | 2.0x | 5.363 |
| parsing | single | 32 | 4 | system-commandline, system-text-json, system-text-json-jsondocument, system-text-json-utf8jsonreader | 2.671 | 2.0x | 5.343 |
| system.text.json | compound | 41 | 6 | async-await, libraries, system-collections-generic-iasyncenumerable, system-text-json, system-text-json-dotnet-10, system-text-json-migrate-from-newtonsoft | 3.534 | 1.5x | 5.301 |
| tools | single | 26 | 4 | cli, csharp, dotnet, system-commandline | 2.611 | 2.0x | 5.223 |
| security | single | 23 | 4 | dotnet-10-library-improvements, json-validation-security, system-text-json, system-text-json-dotnet-10 | 2.581 | 2.0x | 5.163 |
| asp.net core | compound | 16 | 5 | async-await, libraries, system-collections-generic-iasyncenumerable, system-text-json, system-threading-tasks-task | 3.432 | 1.5x | 5.149 |
| dynamic | single | 22 | 4 | inline-arrays, system-text-json, system-text-json-jsonserializer, system-text-json-nodes | 2.571 | 2.0x | 5.143 |
| large | single | 21 | 4 | json-streaming-io, system-collections-generic-ienumerable, system-text-json, system-text-json-jsondocument | 2.561 | 2.0x | 5.123 |
| microsoft | single | 20 | 4 | microsoft-extensions-ai, microsoft-extensions-ai-evaluation, microsoft-extensions-http-resilience, system-text-json | 2.551 | 2.0x | 5.103 |
| streams | single | 19 | 4 | json-streaming-io, system-collections-generic-iasyncenumerable, system-text-json-dotnet-10, system-text-json-utf8jsonwriter | 2.541 | 2.0x | 5.083 |
| zero-allocation | compound | 13 | 5 | collections-performance, csharp-14-features, system-text-json, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter | 3.387 | 1.5x | 5.081 |
| across | single | 18 | 4 | cli, dotnet, libraries, partial-classes | 2.531 | 2.0x | 5.063 |
| interfaces | single | 18 | 4 | collections-performance, microsoft-extensions-ai, partial-classes, type-extensions | 2.531 | 2.0x | 5.063 |
| read-only | compound | 30 | 6 | properties-backing-fields, system-collections-generic-ienumerable, system-text-json, system-text-json-jsondocument, system-text-json-migrate-from-newtonsoft, system-text-json-nodes | 3.369 | 1.5x | 5.053 |
| both | single | 17 | 4 | collections-performance, csharp, file-based-apps, partial-classes | 2.521 | 2.0x | 5.043 |
| modification | single | 17 | 4 | system-collections-generic-ienumerable, system-text-json, system-text-json-jsondocument, system-text-json-nodes | 2.521 | 2.0x | 5.043 |
| responses | single | 17 | 4 | microsoft-extensions-ai-evaluation, system-text-json, system-text-json-source-generation, system-text-json-utf8jsonwriter | 2.521 | 2.0x | 5.043 |
| error handling | compound | 11 | 5 | async-await, file-based-apps, microsoft-extensions-ai, microsoft-extensions-ai-evaluation, system-collections-generic-iasyncenumerable | 3.357 | 1.5x | 5.036 |
| run | single | 16 | 4 | csharp, dotnet, file-based-apps, system-threading-tasks-task | 2.511 | 2.0x | 5.023 |
| startup | single | 16 | 4 | assembly-trimming, native-aot, publishing-and-deployment, system-text-json-source-generation | 2.511 | 2.0x | 5.023 |
| cannot | single | 15 | 4 | inline-arrays, partial-classes, properties-backing-fields, system-text-json-utf8jsonreader | 2.501 | 2.0x | 5.003 |
| vs | single | 14 | 4 | microsoft-extensions-ai, microsoft-extensions-ai-evaluation, string-search-operations, system-threading-tasks-task | 2.491 | 2.0x | 4.983 |
| application | single | 13 | 4 | assembly-trimming, cli, libraries, publishing-and-deployment | 2.481 | 2.0x | 4.963 |
| capabilities | single | 13 | 4 | csharp, file-based-apps, microsoft-extensions-ai, system-collections-generic-ienumerable | 2.481 | 2.0x | 4.963 |
| complex | single | 13 | 4 | file-based-apps, string-search-operations, system-commandline, system-text-json-utf8jsonwriter | 2.481 | 2.0x | 4.963 |
| enable | single | 13 | 4 | collections-performance, csharp, dotnet, type-extensions | 2.481 | 2.0x | 4.963 |
| offers | single | 13 | 4 | csharp, dotnet, system-text-json-jsondocument, system-text-json-nodes | 2.481 | 2.0x | 4.963 |
| provide | single | 13 | 4 | collection-expressions, collection-initialization, csharp, inline-arrays | 2.481 | 2.0x | 4.963 |
| instead | single | 12 | 4 | span-based-string-processing, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-utf8jsonreader | 2.471 | 2.0x | 4.943 |
| cross-platform | compound | 24 | 6 | cli, csharp, dotnet, dotnet-10-library-improvements, file-based-apps, publishing-and-deployment | 3.279 | 1.5x | 4.918 |
| compile-time | compound | 43 | 8 | assembly-trimming, csharp, csharp-14-features, inline-arrays, system-text-json, system-text-json-jsonserializer, system-text-json-nodes, system-text-json-source-generation | 3.132 | 1.5x | 4.699 |
| json | single | 80 | 6 | system-text-json, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-migrate-from-newtonsoft, system-text-json-nodes, system-text-json-utf8jsonwriter | 2.746 | 1.5x | 4.119 |
| iteration | single | 34 | 5 | collections-performance, inline-arrays, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json-jsondocument | 2.468 | 1.5x | 3.702 |
| like | single | 34 | 5 | cli, csharp, dotnet, microsoft-extensions-ai, system-collections-generic-iasyncenumerable | 2.468 | 1.5x | 3.702 |
| gt | single | 27 | 5 | async-await, inline-arrays, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-threading-tasks-task | 2.398 | 1.5x | 3.597 |
| lt | single | 27 | 5 | async-await, inline-arrays, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-threading-tasks-task | 2.398 | 1.5x | 3.597 |
| multiple | single | 25 | 5 | dotnet, system-buffers-searchvalues, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json-nodes | 2.378 | 1.5x | 3.567 |
| during | single | 24 | 5 | json-validation-security, object-initialization, system-collections-generic-iasyncenumerable, system-text-json-jsonserializer, system-text-json-utf8jsonreader | 2.368 | 1.5x | 3.552 |
| known | single | 24 | 5 | collection-initialization, inline-arrays, object-initialization, system-text-json, system-text-json-nodes | 2.368 | 1.5x | 3.552 |
| into | single | 23 | 5 | system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json, system-text-json-jsondocument, system-text-json-nodes | 2.358 | 1.5x | 3.537 |
| through | single | 21 | 5 | collections-performance, csharp, microsoft-extensions-ai-evaluation, microsoft-extensions-http-resilience, system-text-json-utf8jsonreader | 2.338 | 1.5x | 3.507 |
| attributes | single | 20 | 5 | json-validation-security, partial-classes, system-text-json, system-text-json-migrate-from-newtonsoft, system-text-json-source-generation | 2.328 | 1.5x | 3.492 |
| logic | single | 20 | 5 | properties-backing-fields, system-text-json, system-text-json-jsonserializer, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter | 2.328 | 1.5x | 3.492 |
| directly | single | 18 | 5 | inline-arrays, json-streaming-io, properties-backing-fields, span-based-string-processing, system-text-json-utf8jsonwriter | 2.308 | 1.5x | 3.462 |
| nuget | single | 17 | 5 | build-and-compilation, dotnet, file-based-apps, libraries, system-collections-generic-iasyncenumerable | 2.298 | 1.5x | 3.447 |
| data | single | 31 | 6 | csharp, json-validation-security, span-based-string-processing, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json-utf8jsonreader | 2.256 | 1.5x | 3.384 |
| utf-8 | single | 59 | 8 | dotnet-10-library-improvements, json-streaming-io, span-based-string-processing, system-text-json, system-text-json-jsonserializer, system-text-json-source-generation, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter | 2.248 | 1.5x | 3.372 |
| dom | single | 29 | 6 | system-text-json, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-migrate-from-newtonsoft, system-text-json-nodes, system-text-json-utf8jsonreader | 2.236 | 1.5x | 3.354 |
| need | single | 29 | 6 | inline-arrays, properties-backing-fields, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json-jsondocument, system-threading-tasks-task | 2.236 | 1.5x | 3.354 |
| considerations | single | 44 | 7 | async-await, cli, file-based-apps, inline-arrays, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-threading-tasks-task | 2.232 | 1.5x | 3.348 |
| text | single | 67 | 9 | span-based-string-processing, system-text-json, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-migrate-from-newtonsoft, system-text-json-nodes, system-text-json-source-generation, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter | 2.210 | 1.5x | 3.316 |
| don't | single | 26 | 6 | async-await, collections-performance, inline-arrays, system-collections-generic-iasyncenumerable, system-threading-tasks-task, type-extensions | 2.206 | 1.5x | 3.309 |
| avoid | single | 25 | 6 | async-await, inline-arrays, span-based-string-processing, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-threading-tasks-task | 2.196 | 1.5x | 3.294 |
| values | single | 38 | 7 | collection-initialization, system-buffers-searchvalues, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-nodes, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter | 2.172 | 1.5x | 3.258 |
| without | single | 36 | 7 | file-based-apps, inline-arrays, span-based-string-processing, system-collections-generic-iasyncenumerable, system-text-json-jsondocument, system-text-json-nodes, system-text-json-utf8jsonreader | 2.152 | 1.5x | 3.228 |
| control | single | 32 | 7 | csharp, system-collections-generic-iasyncenumerable, system-text-json, system-text-json-jsonserializer, system-text-json-utf8jsonwriter, system-threading-tasks-task, type-extensions | 2.112 | 1.5x | 3.168 |
| no | single | 37 | 8 | collections-performance, inline-arrays, native-aot, partial-classes, publishing-and-deployment, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-text-json | 2.028 | 1.5x | 3.042 |
| use | single | 264 | 30 | async-await, collection-expressions, collection-initialization, collections-performance, csharp, file-based-apps, inline-arrays, json-streaming-io, json-validation-security, lambda-expressions, microsoft-extensions-ai-evaluation, object-initialization, partial-classes, properties-backing-fields, publishing-and-deployment, span-based-string-processing, string-search-operations, system-collections-generic-iasyncenumerable, system-collections-generic-ienumerable, system-commandline, system-text-json, system-text-json-dotnet-10, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-nodes, system-text-json-source-generation, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter, system-threading-tasks-task, type-extensions | 2.976 | 1.0x | 2.976 |
| asp | single | 38 | 10 | async-await, dotnet, json-streaming-io, json-validation-security, libraries, system-collections-generic-iasyncenumerable, system-text-json, system-text-json-jsonserializer, system-text-json-source-generation, system-threading-tasks-task | 1.815 | 1.5x | 2.723 |
| runtime | single | 92 | 13 | cli, collections-performance, csharp, dotnet, inline-arrays, native-aot, publishing-and-deployment, system-text-json, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-nodes, system-text-json-source-generation, system-text-json-utf8jsonwriter | 2.093 | 1.0x | 2.093 |
| system | single | 73 | 11 | cli, libraries, system-collections-generic-iasyncenumerable, system-text-json, system-text-json-jsondocument, system-text-json-jsonserializer, system-text-json-migrate-from-newtonsoft, system-text-json-nodes, system-text-json-source-generation, system-text-json-utf8jsonreader, system-text-json-utf8jsonwriter | 2.070 | 1.0x | 2.070 |
| provides | single | 58 | 12 | async-await, cli, csharp, dotnet, microsoft-extensions-ai, microsoft-extensions-ai-evaluation, partial-classes, system-buffers-searchvalues, system-text-json, system-text-json-dotnet-10, system-text-json-jsondocument, system-text-json-nodes | 1.833 | 1.0x | 1.833 |
| patterns | single | 76 | 16 | cli, collection-expressions, collection-initialization, collections-performance, csharp, csharp-14-features, dotnet-10-library-improvements, inline-arrays, json-streaming-io, libraries, microsoft-extensions-ai, microsoft-extensions-http-resilience, object-initialization, span-based-string-processing, system-collections-generic-iasyncenumerable, system-text-json | 1.725 | 1.0x | 1.725 |
| high-performance | single | 33 | 12 | async-await, collections-performance, csharp, dotnet-10-library-improvements, inline-arrays, json-streaming-io, libraries, span-based-string-processing, system-buffers-searchvalues, system-text-json, system-text-json-dotnet-10, system-text-json-utf8jsonreader | 1.583 | 1.0x | 1.583 |
